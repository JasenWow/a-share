...
def warren_buffett_agent(state: HedgeFundState) -> HedgeFundState:
    ...
    if not ticker or not date:
        ...
        prompt = f"""你是沃伦·巴菲特，价值投资大师。请基于以下A股市场数据进行分析，给出你的投资建议。
...
"""
    ...
    state["data"]["analyst_signals"]["warren_buffett_agent"] = signal.model_dump()
